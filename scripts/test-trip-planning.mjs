...
assert.match(rootHomePage, /<HomeDiscoveryPage locale=\{locale\} selectedCity=\{selectedCity\} \/>/);
assert.match(localizedHomePage, /<HomeDiscoveryPage locale=\{locale\} selectedCity=\{selectedCity\} \/>/);
