...
const serviceInfoCopy: Record<Locale, { title: string; description: string; sections: Array<{ title: string; body: string }> }> = {
  zh: {
    title: "服务说明",
    description: "韩国旅行助手帮助自由行游客在釜山、首尔、济州更快做出旅行决定。",
    sections: [
      { title: "服务范围", body: "提供地点搜索、点单指南、拍照地点、行李寄存、翻译句子、附近推荐和行程整理功能。" },
  ...
  en: {
    ...
    description: "Korea Travel Assistant helps independent travelers make faster travel decisions in Busan, Seoul, and Jeju.",
    sections: [
      { title: "Scope", body: "The service provides place search, ordering guidance, photo spots, luggage storage, Korean phrases, nearby recommendations, and itinerary tools." },
  ...
  ja: {
    title: "サービス案内",
    description: "韓国旅行アシスタントは、釜山・ソウル・済州を旅行する個人旅行者の判断を支援します。",
    sections: [
      { title: "サービス範囲", body: "スポット検索、注文ガイド、写真スポット、荷物預かり、韓国語フレーズ、近くのおすすめ、旅程整理機能を提供します。" },
  ...
  ko: {
    title: "서비스 안내",
    description: "한국 여행 어시스턴트는 부산·서울·제주를 여행하는 자유여행객의 빠른 의사결정을 돕습니다.",
    sections: [
      { title: "서비스 범위", body: "장소 검색, 주문 가이드, 사진스팟, 짐보관, 한국어 안내 문장, 주변 추천, 일정 정리 기능을 제공합니다." },
