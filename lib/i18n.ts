...
export const ui = {
  zh: {
    ...
    authFlow: {
      signinTitle: "登录",
      signupTitle: "注册账号",
      signinDescription: "未登录也可以在此设备保存地点和行程。登录后，可把已保存的地点和行程合并到账号，并在其他设备继续查看。",
      signupDescription: "创建账号后，可把此设备上的保存地点和行程合并到账号，并在其他设备继续查看。",
      email: "邮箱",
      password: "密码",
      socialLogin: {
        kakao: "使用 Kakao 登录",
      ...
      signinErrorFallback: "无法登录。请检查邮箱和密码后重试。",
      signupErrorFallback: "无法创建账号。请稍后重试。",
      oauthCancelled: "登录已取消。需要时可以再次尝试。",
      oauthMissingCode: "登录返回信息不完整。请重新尝试。",
      oauthErrorFallback: "社交登录失败。请稍后重试，或使用邮箱登录。",
      callbackTitle: "正在完成登录",
      callbackProcessing: "正在安全地确认登录信息。",
    ...
    notFound: {
      title: "没有找到页面",
      description: "请求的页面不存在，或链接已经失效。",
      home: "回到首页",
    },
    admin: {
      eyebrow: "管理",
      title: "Korea Travel Assistant 管理",
      description: "审核用户提交的地点，补充缺失数据后发布为最终地点。",
      checkingTitle: "正在确认管理员权限",
      checkingDescription: "正在确认登录会话和管理员权限。",
      loginTitle: "需要登录",
      loginDescription: "管理员区域需运营者登录后才能访问。",
      forbiddenTitle: "无法访问",
      forbiddenDescription: "需要管理员权限。",
      menu: "管理员菜单",
      guides: "旅行指南 / 路线管理",
    },
    footerLinks: {
  ...
  en: {
    ...
    authFlow: {
      ...
      signinDescription: "You can save places and trips on this device without signing in. Sign in to merge saved places and trips into your account and continue on other devices.",
      signupDescription: "Create an account to merge saved places and trips from this device into your account and continue on other devices.",
      email: "Email",
      password: "Password",
      socialLogin: {
      ...
      signinErrorFallback: "Could not sign in. Check your email and password, then try again.",
      signupErrorFallback: "Could not create the account. Please try again later.",
      oauthCancelled: "Sign-in was cancelled. You can try again when ready.",
      oauthMissingCode: "The sign-in response was incomplete. Please try again.",
      oauthErrorFallback: "Social sign-in failed. Please try again, or use email.",
      callbackTitle: "Finishing sign-in",
      callbackProcessing: "Securely confirming your sign-in.",
    ...
    notFound: {
      ...
      description: "The page does not exist, or the link is no longer available.",
      home: "Back to home",
    },
    admin: {
      eyebrow: "Admin",
      title: "Korea Travel Assistant admin",
      description: "Review user-submitted places, fill missing data, and publish final place records.",
      checkingTitle: "Checking admin access",
      checkingDescription: "Checking your session and administrator permissions.",
      loginTitle: "Sign-in required",
      loginDescription: "The admin area is available after operator sign-in.",
      forbiddenTitle: "Access denied",
      forbiddenDescription: "Administrator permission is required.",
      menu: "Admin menu",
      guides: "Travel guide / route management",
    },
    footerLinks: {
    ...
    mypage: {
      ...
      loginTitle: "Sign in to sync your travel history",
      profile: "Profile",
      email: "Email",
      nickname: "Nickname",
      joinedAt: "Joined",
  ...
  ja: {
    ...
    authFlow: {
      signinTitle: "ログイン",
      signupTitle: "アカウント登録",
      signinDescription: "ログインしなくても、この端末にスポットや旅程を保存できます。ログインすると保存スポットと旅程をアカウントに統合し、他の端末でも続きから確認できます。",
      signupDescription: "アカウントを作成すると、この端末の保存スポットと旅程をアカウントに統合し、他の端末でも続きから確認できます。",
      email: "メール",
      password: "パスワード",
      socialLogin: {
        kakao: "Kakaoでログイン",
      ...
      emailDivider: "またはメールでログイン",
      signinSubmit: "ログイン",
      signupSubmit: "アカウント作成",
      switchToSignup: "アカウントがない場合は登録",
      switchToSignin: "アカウントがある場合はログイン",
      signinErrorFallback: "ログインできませんでした。メールとパスワードを確認して再度お試しください。",
      signupErrorFallback: "アカウントを作成できませんでした。時間をおいて再度お試しください。",
      oauthCancelled: "ログインがキャンセルされました。必要なときに再度お試しください。",
      oauthMissingCode: "ログインの戻り値が不完全です。もう一度お試しください。",
      oauthErrorFallback: "ソーシャルログインに失敗しました。再度試すか、メールでログインしてください。",
      callbackTitle: "ログインを完了しています",
      callbackProcessing: "ログイン情報を安全に確認しています。",
    ...
    notFound: {
      title: "ページが見つかりません",
      description: "お探しのページは存在しないか、リンクが無効になっています。",
      home: "ホームへ戻る",
    },
    admin: {
      eyebrow: "管理",
      title: "Korea Travel Assistant 管理",
      description: "ユーザー投稿スポットを確認し、不足データを補完して最終スポットとして公開します。",
      checkingTitle: "管理者権限を確認中",
      checkingDescription: "ログインセッションと管理者権限を確認しています。",
      loginTitle: "ログインが必要です",
      loginDescription: "管理者エリアは運営者ログイン後にアクセスできます。",
      forbiddenTitle: "アクセスできません",
      forbiddenDescription: "管理者権限が必要です。",
      menu: "管理メニュー",
      guides: "旅行ガイド / ルート管理",
    },
    footerLinks: {
  ...
  ko: {
    ...
    authFlow: {
      signinTitle: "로그인",
      signupTitle: "회원가입",
      signinDescription: "로그인하지 않아도 이 기기에 장소와 일정을 저장할 수 있습니다. 로그인하면 저장 장소와 일정을 계정에 병합하여 다른 기기에서도 이어볼 수 있습니다.",
      signupDescription: "계정을 만들면 이 기기에 저장한 장소와 일정을 계정에 병합하여 다른 기기에서도 이어볼 수 있습니다.",
      email: "이메일",
      password: "비밀번호",
      socialLogin: {
        kakao: "카카오로 로그인",
      ...
      emailDivider: "또는 이메일로 로그인",
      signinSubmit: "로그인",
      signupSubmit: "계정 만들기",
      switchToSignup: "계정이 없나요? 회원가입",
      switchToSignin: "계정이 있나요? 로그인",
      signinErrorFallback: "로그인할 수 없습니다. 이메일과 비밀번호를 확인한 뒤 다시 시도해 주세요.",
      signupErrorFallback: "계정을 만들 수 없습니다. 잠시 후 다시 시도해 주세요.",
      oauthCancelled: "로그인이 취소되었습니다. 필요할 때 다시 시도해 주세요.",
      oauthMissingCode: "로그인 응답이 올바르지 않습니다. 다시 시도해 주세요.",
      oauthErrorFallback: "소셜 로그인에 실패했습니다. 다시 시도하거나 이메일로 로그인해 주세요.",
      callbackTitle: "로그인을 완료하는 중",
      callbackProcessing: "로그인 정보를 안전하게 확인하고 있습니다.",
    ...
    notFound: {
      ...
      description: "요청한 페이지가 없거나 링크가 더 이상 유효하지 않습니다.",
      home: "홈으로 돌아가기",
    },
    admin: {
      eyebrow: "관리자",
      title: "한국 여행 어시스턴트 관리자",
      description: "사용자 장소 제보를 검수하고, 부족한 데이터를 보완해 최종 장소로 등록합니다.",
      checkingTitle: "관리자 확인 중",
      checkingDescription: "로그인 세션과 관리자 권한을 확인하고 있습니다.",
      loginTitle: "로그인이 필요합니다",
      loginDescription: "관리자 영역은 운영자 로그인 후 접근할 수 있습니다.",
      forbiddenTitle: "접근할 수 없습니다",
      forbiddenDescription: "관리자 권한이 필요합니다.",
      menu: "관리자 메뉴",
      guides: "여행 가이드 / 여행 코스 관리",
    },
    footerLinks: {
      serviceInfo: "서비스 안내",
      privacy: "개인정보처리방침",
